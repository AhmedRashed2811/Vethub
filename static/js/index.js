...
const data = {
  "Cairo": ["Nasr City", "Abbassia", "Ain Shams",
            "Al-Wayli", "Azbakeya", "Bab al-Louq", 
            "Boulaq", "Downtown Cairo", "El Manial", 
            "El Marg", "El Matareya", "El Qobbah", 
            "Ezbet El Nakhl", "Faggala", "Fifth Settlement",
            "Forth Settlement", "Third Settlement", "Second Settlement", 
            "First Settlement", "New Cairo", "New Capital City", 
            "Fustat", "Garden City", "Heliopolis", 
            "Maadi", "New Maadi", "Old Cairo", 
            "Shubra", "Wagh El Birket", "El Sakkakini", 
            "Zeitoun", "Basateen", "Masr Elgdida",
            "Almaza", "Alf Maskn", "Mo2tam"  ],
...
bill?.addEventListener("click", () => {
  notification.classList.toggle("d:\style14.css");
