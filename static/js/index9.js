...
const data = {
  ...
  "Matrouh":
  [
    "Marsa Matrouh","Al Hamam",
    "Al Hamam Al Gadeeda","Al Alamein","Dabaa",
    "Sidi Abdel Rahman","Al Njaila",
    "Al Saloum","Siwa","Barany"
  ],

  "North Sinai": [
    "Al Arish","Rafah","Bir al-Abd",
    "Bir al-Abd Al Gadeeda","Al Hasana",
    "Al Hasana Al Gadeeda","Sheikh Zuweid","Nakhl",
  ],

  "Red Sea": [
    "Hurghada","Ras Gharib","Safaga",
  ...
  "Al-Wadi Al-Gadeed":[
    "Al Kharga","Baris",
    "Farafra","Farafra Al Gadeeda",
    "Dakhla","Balat",
  ],

  "South Sinai": [
    "Sharm El Sheikh","Nuweiba","Taba",
    "Ras Sidr","Saint Catherine",
    "Abu Redis","Abu Zenima",
    "At-Tur","Yellow Mountain"
  ]
